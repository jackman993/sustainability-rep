...
def generate_mock_data(prompt_id: str, industry: str = None, carbon_emission: Dict[str, Any] = None) -> List[str]:
    ...
    if 'trans' in prompt_id:
        return [
            # Line 1: Policy & Regulation Risk (對應 Row 2)
            f"Policy & Regulation Risk;{industry} sector faces new carbon tax regulations and stricter environmental compliance requirements. Government policies mandate 30% emission reduction by 2030, requiring immediate action ||| Financial Impact: $500K-1M annually in carbon taxes, plus $200K-400K in compliance costs. Potential penalties up to $500K for non-compliance ||| Mitigation: Invest in carbon offset programs and energy efficiency upgrades. Implement comprehensive compliance monitoring system. Budget: $200K initial, $150K annually for maintenance and monitoring",
            # Line 2: Green Product & Technology Risk (對應 Row 3)
            f"Green Product & Technology Risk;Shift to green technology and sustainable products disrupting traditional {industry} markets. Competitors adopting low-carbon technologies and eco-friendly alternatives gaining market advantage ||| Financial Impact: Technology obsolescence risk $1M-2M. Need for R&D investment $1.5M-3M to stay competitive. Market share erosion 10-15% if no action ||| Mitigation: Accelerate green technology R&D and develop sustainable product lines. Establish partnerships with green tech suppliers. Budget: $1M initial investment, $500K annually for R&D",
            # Line 3: Market Disruption Risk (對應 Row 4) - 重點加強市場分析
            f"Market Disruption Risk;Significant market shifts in {industry} sector driven by changing consumer preferences, competitive dynamics, and supply chain transformations. Customer demand increasingly favors sustainable and low-carbon solutions ||| Financial Impact: Market share decline of 15-25% over next 3 years. Revenue risk $2M-5M. Loss of key clients worth $800K-1.5M annually. Competitive disadvantage in emerging green markets ||| Mitigation: Develop comprehensive market repositioning strategy. Invest in sustainable product portfolio and market entry into green segments. Enhance customer engagement and supply chain transparency. Budget: $1.2M for market strategy, $600K for product development",
            # Line 4: Reputation & Brand Risk (對應 Row 5)
            f"Reputation & Brand Risk;Growing public awareness of climate issues increases scrutiny on {industry} companies. Negative media coverage of environmental practices can damage brand value significantly. ESG ratings and investor confidence at risk ||| Financial Impact: $1M-3M in potential brand value loss. Customer churn risk of 10-20%. Increased marketing costs of $300K-600K to rebuild reputation. Potential loss of investor confidence affecting stock valuation ||| Mitigation: Implement transparent sustainability reporting and engage in proactive environmental initiatives. Develop comprehensive ESG communication strategy. Enhance stakeholder engagement. Budget: $400K for reporting systems, $200K annually for communications"
        ]
