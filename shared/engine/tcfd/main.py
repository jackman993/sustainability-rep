...
def generate_mock_data(prompt_id: str, industry: str = None, carbon_emission: Dict[str, Any] = None) -> List[str]:
    ...
    if 'trans' in prompt_id:
        return [
            ...
            f"Market & Technology Risk;Shift to green technology may disrupt traditional {industry} markets. Consumer preferences increasingly favor sustainable products, threatening market share of conventional offerings ||| Financial Impact: $2M-5M revenue risk over next 3 years. Market share decline of 15-25% if no action taken. Additional R&D costs of $1.5M-3M required ||| Mitigation: Develop green product lines and invest in sustainable technology R&D. Establish partnerships with green tech suppliers. Budget: $1M initial investment, $500K annually for R&D",
            f"Reputation & Brand Risk;Growing public awareness of climate issues increases scrutiny on {industry} companies. Negative media coverage of environmental practices can damage brand value significantly ||| Financial Impact: $1M-3M in potential brand value loss. Customer churn risk of 10-20%. Increased marketing costs of $300K-600K to rebuild reputation ||| Mitigation: Implement transparent sustainability reporting and engage in proactive environmental initiatives. Develop comprehensive ESG communication strategy. Budget: $400K for reporting systems, $200K annually for communications",
            f"Legal & Litigation Risk;Increasing climate-related lawsuits targeting high-emission industries. Regulatory enforcement actions and shareholder activism on the rise ||| Financial Impact: $500K-2M in potential legal costs and settlements. Increased insurance premiums of $100K-300K annually. Risk of operational restrictions ||| Mitigation: Strengthen legal compliance framework and engage with stakeholders proactively. Establish climate risk management protocols. Budget: $300K for legal framework, $150K annually for compliance monitoring"
        ]
